      ...
      >
        <div>
          <div className="mx-auto h-20 w-20 rounded-2xl overflow-hidden shadow-lg shadow-[#0f1f3d]/20">
            <img src={LOGO_URL} alt="LPMX Logo" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
          </div>
        ...
        <div className="mt-8">
          <button
            onClick={handleLogin}
            disabled={loading}
            className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-xl text-white bg-[#0f1f3d] hover:bg-[#1a3366] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0f1f3d] transition-all shadow-lg shadow-[#0f1f3d]/20 disabled:opacity-70"
          >
